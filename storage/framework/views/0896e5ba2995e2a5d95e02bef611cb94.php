...
$message = $__bag->first($__errorArgs[0]); ?>
                    <p class="mt-1 text-xs italic text-red-500"><?php echo e($message); ?></p>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Profile Picture -->
                <div class="mt-4">
                    <label for="photo" class="block text-sm font-medium text-gray-700"><?php echo e(__('Profile Picture')); ?></label>
                    <input id="photo" type="file" class="form-input w-full <?php $__errorArgs = ['photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center justify-end mt-4">
                    <a href="<?php echo e(route('login')); ?>"
                        class="text-sm text-gray-600 underline hover:text-gray-900"><?php echo e(__('Already registered?')); ?></a>
...
<?php endif; ?>
<?php /**PATH /home/jay/Downloads/laravel/chatApplication/themes/tailwind/views/auth/register.blade.php ENDPATH**/ ?>